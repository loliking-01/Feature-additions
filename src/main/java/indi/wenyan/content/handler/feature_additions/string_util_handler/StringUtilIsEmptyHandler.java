 ...
 * @version 1.0
 * @className StringUtilIsEmptyHandler
 * @Description TODO
 * @date 2025/6/15 0:20
 */
public class StringUtilIsEmptyHandler implements JavacallHandler {
    ...
    public WenyanNativeValue handle(JavacallContext context) throws WenyanException.WenyanThrowException {
        ...
        return new WenyanNativeValue(WenyanType.BOOL,original.isEmpty(),false);
    }
